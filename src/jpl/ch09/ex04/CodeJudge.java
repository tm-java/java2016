...
public class CodeJudge {
	...
	public static void main(String [] args){
		int i = 3;
		 ...
		 System.out.println(Integer.MAX_VALUE + Integer.MIN_VALUE);//-> Integer 0
		 System.out.println(Long.MAX_VALUE + 5);//-> 正しくない
		 System.out.println((short) 5 * (byte) 10);//-> short 50
		 System.out.println((i < 15 ? 1.72e3f : 0));//-> double 1.72e3f or 0.0
